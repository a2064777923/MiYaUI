...
<div class="b2-single-content wrapper mg-b">
    ...
    <?php echo get_ask_list() ?>
    <div id="primary-home" class="content-area wrapper ask-archive b2-radius" ref="askarchive" data-paged="<?php echo $paged; ?>" data-count="<?php echo $count; ?>" data-term="0">
        <?php

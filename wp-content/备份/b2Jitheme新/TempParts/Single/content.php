...
<article class="single-article b2-radius box">
    ...
    <!--    <div class="post-note"><b>声明：</b>本文由<span><strong><a href="<?php echo $post_meta['user_link']; ?>" title="查看与【<?php echo $post_meta['user_name']; ?>】相关的文章" target="_blank"><?php echo $post_meta['user_name']; ?></a></strong></span>发布，本站所有文章，如无特殊说明或标注，均为本站原创发布。任何个人或组织，在未征得本站同意时，禁止复制、盗用、采集、发布本站内容到任何网站、书籍等各类媒体平台。如若本站内容侵犯了原著者的合法权益，可联系我们进行处理。</div>-->
    <!--</div>-->

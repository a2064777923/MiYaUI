        ...
        <main id="main" class="site-main">
            ...
            <div class="register-form box b2-radius">
                ...
                <form @submit.stop.prevent="submit">
                    <div class="from-in">
                        <label class="link-thumb b2-radius"
                            :style="link_image ? 'background-image:url('+link_image+')' : ''">
                            <input type="file" placeholder="<?php echo __('图标', 'b2'); ?>"
                                accept="image/jpg,image/jpeg,image/png,image/gif" ref="fileInput" @change="imgUpload"
                                :disabled="locked" />
                        ...
                        <div class="link-input-box">
                            ...
                            <label><input type="text" placeholder="<?php echo __('网站网址', 'b2'); ?>"
                                    v-model="link_url" /></label>
                        </div>
                    </div>

                ...
                <div class="ask-single-info">
                    ...
                    <div class="ask-footer">
                        <div class="ask-metas">
                            ...
                            <span class="ask-favorite" @click="jubao.close('ask',<?php echo $post->ID; ?>)"><?php echo b2_get_icon('b2-shield-user-line'); ?><?php echo __('举报','b2'); ?></span>
                        ...
                        <div :class="['answer-item',{'new-comment':item.new}]" v-for="(item,i) in data.data" :key="i" :id="'answer-item-'+item.post_id">
                            ...
                            <div class="answer-date b2flex">
                                ...
                                <div class="b2flex">
                                    ...
                                    <div class="ask-favorite" @click="jubao.close('answer',<?php echo $post->ID; ?>)"><?php echo b2_get_icon('b2-shield-user-line'); ?><?php echo __('举报','b2'); ?></div>
                                </div>
                            </div>
                            <div class="answer-footer b2flex">
                                <div class="answer-footer-left b2flex">
                                    ...
                                    <!-- <span><?php echo b2_get_icon('b2-star-fill'); ?>收藏<?php echo sprintf(__('收藏 %s','b2'),'<b v-text="item.favorites"></b>'); ?></span>

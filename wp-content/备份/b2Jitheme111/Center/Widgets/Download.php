...
class Download extends \WP_Widget{
	...
	public static function get_widget( $atts ) {
        $Single_wysiwyg=b2_get_option('Jitheme_post_main','Single_wysiwyg');
        if(empty($Single_wysiwyg)){
            $Single_wysiwyg = '请到子主题后台-文章内页中设置版权信息。';
        }
        //获取设置项
		...
		$html = '
            ...
            <div class="wdlist jitheme-widget-down" ref="wdlist">
                <div class="w-d-list" v-for="(item,index) in list" :key="index">
                    <h2 class="downloadurl"><i class="jitheme jitheme-suoding"></i>下载地址</h2>

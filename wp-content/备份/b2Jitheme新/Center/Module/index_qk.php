...
$index_qukuai_jg=b2_get_option('Jitheme_index_tab3','index_qukuai_jg');
if(!empty($index_qukuai_jg) && $index_qukuai_jg = 1){
    $sty="";
}else{
    $sty="shangxia";
}
...
<div class="box home-row-left content-area b2-radius"> 
            <div class="sort <?php echo $sty ?> b2-radius">    
                                ...
                                foreach ($aside_qkcode as $k => $v) {
                                    if($v['index_qukuai_img']){
                                        ...
                                        if($v['qukuai_img']){
                                            ...
                                            $qukuai_img_html='<div class="item-ico  b2-radius">'.jitheme_get_icon($v['qukuai_img_ico'],$v['qukuai_img_xmmc']).'</div>';
                                        }
                                        $html = '<li>

...
class Seo
{
    ...
    public function seo_head_meta()
    {
        ...
        global $wp;
        $current_url = esc_url(B2_HOME_URI . '/' . add_query_arg(array(), $wp->request));
    ...
    <meta name="description" content="' . $meta['description'] . '" />
    <meta property="og:image" content="' . $meta['image'] . '" />
    <meta property="og:updated_time" content="' . esc_attr($meta['updated_time']) . '" />
    <meta property="article:author" content="' . esc_attr($meta['author']) . '" />
            ';
            ...
            if (isset($term->term_id)) {
                ...
                echo '
    <meta name="keywords" content="' . esc_attr(self::get_term_meta($term->term_id, 'seo_keywords')) . '" />
    <meta name="description" content="' . esc_attr(trim(strip_tags(get_the_archive_description()))) . '" />
    <meta property="og:image" content="' . esc_url(b2_get_thumb(array('thumb' => $img, 'width' => 600, 'height' => 400))) . '" />
                ';
            }
    ...
    public static function single_meta($post_id = 0)
    {
        ...
        return array(
            ...
            'image' => esc_url(b2_get_thumb(array('thumb' => $thumb_url, 'width' => 600, 'height' => 400))),
            'url' => esc_url(get_permalink($post_id)),
            'updated_time' => get_the_modified_date('c', $post_id),
            'author' => esc_url(get_author_posts_url($author))
        );
    }
}
...
<div class="entry-content">
   <div id="jitheme_post_mp3" class="">
                ...
                <div class="audio-info">
        			<div class="audio-box"  style="background: url(<?php echo $thumb; ?>) no-repeat;background-size:100% 100%; " >
                        <div class="audio-left">
                            <img id="audioPlayer" class="" src="<?php echo B2_CHILD_URI ?>/Center/Assets/images/mp3/play.svg">
                            <div class="cover-bg" style="background: url(<?php echo $thumb; ?>) no-repeat;background-size:100% 100%; "></div>
                        </div>

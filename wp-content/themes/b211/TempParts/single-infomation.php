    ...
    <div class="entry-content">
        ...
        <div class="content-footer">
            <div class="content-footer-poster">
                ...
                <button class="jubao-button text favorite-button" @click="jubao.close('infomation',<?php echo $post_id; ?>)"><?php echo b2_get_icon('b2-shield-user-line'); ?><?php echo __('举报','b2'); ?></button>
            </div>
        </div>

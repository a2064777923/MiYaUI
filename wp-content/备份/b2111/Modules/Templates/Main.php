...
class Main{
    ...
    public function setup_frontend_scripts(){
        ...
        //加载字体
        wp_enqueue_style( 'b2-fonts', B2_THEME_URI.'/Assets/fonts/iconfont.css' , array() , B2_VERSION , 'all');
        ...
        if($fonts !== 0){
            ...
            $cdn = b2_get_option('template_main','fonts_cdn');
            $font_link = b2_get_option('template_main','fonts_link');
            if(!wp_is_mobile()){
                if($fonts == 1){
                    $link = 'https://cdn.jsdelivr.net/gh/liruchun/b2procdn/';
                    if((int)$cdn == 1){
                        $link = $font_link;
                    }
                    $css .= '
                    @font-face {
                        ...
                        src: url("'.$link.'OPPOSans-Regular.woff");
                        font-display: swap;
                    }
                ...
                if($fonts == 2){
                    ...
                    @font-face {
                        ...
                        src: url(\''.$link.'HarmonyOS_Sans_SC_Medium.woff2\') format(\'woff2\'),
                             url(\''.$link.'HarmonyOS_Sans_SC_Medium.woff\') format(\'woff\');
                             font-display: swap;
                    }
                    body,button,select,input,textarea{
                ...
                if($fonts == 3){
                    $link = 'https://fonts.loli.net/css2?family=Noto+Serif+SC&display=swap';
                    if((int)$cdn == 1){
                        $link = $font_link.'Noto_Serif_SC.css';
                    }
                    wp_enqueue_style( 'Noto-fonts', apply_filters('b2_noto_fonts_link', $link), array(), B2_VERSION , 'all' );
                ...
                if($fonts == 4){
                    ...
                    if((int)$cdn == 1){
                        $link = $font_link.'WenKai.css';
                    }
                    wp_enqueue_style( 'LXGW-WenKai', apply_filters('b2_noto_fonts_link', $link), array(), B2_VERSION , 'all' );
                    $css .= apply_filters('b2_noto_font_family', 'body,button,select,input,textarea{
                ...
                if($fonts == 5){
                    ...
                    @font-face {
                        ...
                        src: url("'.$link.'sourcehansans/sourcehansans.eot"); /* IE9 Compat Modes */ /*这里以及下面的src后面的地址填的都是自己本地的相对地址*/
                        src: url("'.$link.'sourcehansans/sourcehansans.eot?#iefix") format("embedded-opentype"),
                          /* IE6-IE8 */ url("'.$link.'sourcehansans/sourcehansans.woff") format("woff"),
                          /* Modern Browsers */ url("'.$link.'sourcehansans/sourcehansans.ttf") format("truetype"),
                          /* Safari, Android, iOS */ url("'.$link.'sourcehansans/sourcehansans.svg#YourWebFontName")

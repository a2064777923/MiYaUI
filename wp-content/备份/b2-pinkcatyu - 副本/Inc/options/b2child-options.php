...
CSF::createOptions( $prefix, array(
	'framework_title'         => '粉色猫语-B2子主题选项',
	'framework_class'         => 'be-box',

	'menu_title'              => '粉色猫语-B2子主题选项',
...
CSF::createSection( $prefix, array(
	...
	'fields'      => array(
		...
		array(
			...
			'title'   => '🌸快速定位设置项',
			'type'    => 'content',
			'content' => '点击右上&nbsp;&nbsp;<i class="dashicons dashicons-plus-alt"></i>展开所有设置按钮，在同一个页面显示所有设置，利用浏览器搜索功能（Ctrl+f），输入关键字定位到设置项',
		),
		...
		array(
			...
			'title'   => '🌸bug反馈',
			'type'    => 'content',
			'content' => '作者：森语 QQ:1035761010 (任何问题都可以反馈给我)',
		),
		
		array(
			'title'   => '🌸当前版本',
			'type'    => 'content',
			'content' => '当前版本：'.THEME_VERSION.' | <a href="https://www.lsenyu.com/" target="_blank" rel="external nofollow" class="url themes-inf">主题日志</a> |
                    <a href="http://qm.qq.com/cgi-bin/qm/qr?_wv=1027&k=PNPixOYu_RqEw6YLw1iEpTraKgH4PwPW&authKey=LpsvTcq2QuZdCORf2m2NOvlL6OaLZt6%2ByU7HUTn%2BAGFqnJ1bI%2B6273fA5d4RnWf6&noverify=0&group_code=783754655" target="_blank" rel="external nofollow" class="url themes-inf">交流群:783754655</a>',
		),
	)
));
...
CSF::createSection( $prefix, array(
	...
	'fields'      => array(
		...
		array(
			...
			'type'     => 'switcher',
			'title'    => '文章p标签超级版权',
			'after'    => '文章每个p标签都有版权-逻辑上对采集站有好处，因为效果与随机添加Ascii码修改一样（自行斟酌）',
		),
		array(
			'id'       => 'link_external',
			'type'     => 'switcher',
		...
		array(
			'id'       => 'page_FancyBox_text',
			'class'    => 'be-child-item be-child-last-item',
			'type'     => 'text',
			'title'    => '填入：.wp-block-image',
			'default'  => '.wp-block-image',
			'dependency' => array('page_FancyBox', '==', 'true'),
		),
    )
));
CSF::createSection( $prefix, array(
...
//美化模块
CSF::createSection( $prefix, array(
	'id'     => 'mhu_style_setting',
	'title'  => '美化模块',
	'icon'  => 'dashicons dashicons-admin-appearance',
) );
CSF::createSection( $prefix, array(
	'parent'      => 'mhu_style_setting',
	'title'       => '首页美化',
	'icon'        => '',
	...
	'fields'      => array(
		...
		array(
			...
			'title'    => '视频',
			'preview'  => true,
			'default'  => 'https://img-baofun.zhhainiao.com/pcwallpaper_ugc/preview/357ae8bfe853304b43c5b4dd262135fd_preview.mp4',
...
CSF::createSection( $prefix, array(
	...
	'fields'      => array(
		...
		array(
			...
			'title'    => '数据库文件名称',
			'default'  => 'qqwry',
			'after'    => '纯真IP库，默认qqwry <a href="https://www.lsenyu.com/">纯真IP库</a>',
		),
		array(
			'id'       => 'page_yiyan',
			'type'     => 'switcher',

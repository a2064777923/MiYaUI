            ...
            <div class="user-panel-info">
                ...
                <div class="user-panel-editor-button">
                    <div class="user-follow jitheme-button" v-show="!self && avatar" v-cloak>
                        <button class="red-color" v-if="followed == false" @click="followingAc()"><?php echo b2_get_icon('b2-add-line').'<span>'.__('关注Ta','b2').'</span>'; ?></button>
                        <button class="author-has-follow" v-else @click="followingAc()"><?php echo __('取消关注','b2'); ?></button>
                        <button class="empty blue-color" @click="dmsg()"><?php echo b2_get_icon('b2-mail-send-line').'<span>'.__('发私信','b2').'</span>'; ?></button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="author-table mg-t">
        <div class="author-page-right">
            <div class="author-page-right-in box b2-radius">
                ...
                <?php echo do_action('custom_user_sidebar'); ?>
                <div class="user-sidebar">

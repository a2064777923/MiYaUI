...
$open = b2_get_option('document_main', 'document_open');
        ...
        <div class="document-top-search">
            <form method="get" action="<?php echo B2_HOME_URI; ?>" class="single-document-search">
                <input type="text" name="s" autocomplete="off" class="search-input b2-radius"
                    placeholder="<?php echo __('请输入关键词', 'b2'); ?>">
    ...
    <div class="document-left widget-area b2-pd-r">
        ...
        <div class="document-left-item box b2-radius request-supper">
            ...
            <div><a href="javascript:void(0)" class="button"
                    @click="canRequest('<?php echo b2_get_custom_page_url('requests'); ?>')"><?php echo __('提交工单', 'b2'); ?></a>
            </div>
        </div>
    </div>

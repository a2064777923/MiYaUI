...
use B2\Modules\Common\UrlDetails;
...
// $res = Orders::get_order_info('EC05906275659637-0');
echo '<pre>';
var_dump(apply_filters('b2_get_download_edit_data',44198));
// var_dump(get_post_meta(44198,'b2_single_post_download_group','true'));

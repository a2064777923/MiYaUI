...
var postType5 = new Vue({
    ...
    iframe = '<iframe src="/wp-content/themes/b2Jitheme/dmku/?url=' + data.url + '" allowFullScreen="true"></iframe>';

    document.getElementById('post-style-5-player').innerHTML = iframe;

    document.querySelector('.post-video-list').style.height = 
        document.querySelector('.post-style-5-video-box-in').clientHeight + 'px'
},
        ...
        selectVideo(index,res){
            ...
            this.setIframe(this.getVideoData(index))
        },
        getDogeVideo(data){

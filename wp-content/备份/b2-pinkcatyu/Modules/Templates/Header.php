            ...
            <ul class="abcd_memberCard_member-benefits">
                <div class="abcd_memberCard_benefitsLiWrapper" style="left: 0px;"> <li>
                                            <div class="abcd_benefitTag_benefits-wrapper">
                                                <i class="benefitTag__benefits-icon___3aeab" style="background: url(/wp-content/themes/b2child_S9/Assets/img/20220707012917663.svg) center center / contain no-repeat;">
                                                </i>
                                            ...
                                            <div class="abcd_benefitTag_benefits-wrapper">
                                                <i class="benefitTag__benefits-icon___3aeab" style="background: url(/wp-content/themes/b2child_S9/Assets/img/20220707012915212.svg) center center / contain no-repeat;">
                                                </i>
                                                <span class="benefitTag__benefits-text___5d19f">
                                                  免费指导
                                                </span>
                                            ...
                                            <div class="abcd_benefitTag_benefits-wrapper">
                                                <i class="benefitTag__benefits-icon___3aeab" style="background: url(/wp-content/themes/b2child_S9/Assets/img/20220707012914275.svg) center center / contain no-repeat;">
                                                </i>
                                                <span class="benefitTag__benefits-text___5d19f">
                                                  保持更新
                                                </span>
                                            ...
                                            <div class="abcd_benefitTag_benefits-wrapper">
                                                <i class="benefitTag__benefits-icon___3aeab" style="background: url(/wp-content/themes/b2child_S9/Assets/img/20220707012912468.svg) center center / contain no-repeat;">
                                                </i>
                                                <span class="benefitTag__benefits-text___5d19f">
                                                  免费更新
                                                </span>
    ...
    public static function user_info(){
        ...
        $html = '<div class="top-user-box" v-if="b2token" v-cloak>
            <div class="top-user-avatar avatar-parent" @click.stop="showDropMenu">
                ...
                <span v-if="userData.user_title">'.b2_get_icon('vrnzhengss').'</span>
            </div>

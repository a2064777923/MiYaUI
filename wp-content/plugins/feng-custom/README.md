...
晨风自定义，友情链接及链接RSS聚合功能，网页特效包含节日氛围、雪花飘落、底部运行天数、网页灰色、输入框七彩光子、图片灯箱特效等等。
...
1. 使用FTP等方式上传插件，将获得文件夹上传至wordpress安装目录下的 “/wp-content/plugins/”目录.

2. WordPress仪表盘上传插件，仪表盘->插件->添加新插件->上传插件

启用插件

WordPress仪表盘启用插件，仪表盘->插件->已安装插件，在插件列表中找到“晨风自定义”，点击“启用”.
...
Fancybox（图片灯箱） v4.0.22
[https://fancyapps.com/docs/ui/quick-start](https://fancyapps.com/docs/ui/quick-start)

Fanybox是JavaScript灯箱的终极替代品，它为多媒体显示的高级用户体验设定了标准。支持图像，视频，地图，内联内容，iframes和任何其他HTML内容。

activate-power-mode（输入框七彩光子特效）
[https://github.com/disjukr/activate-power-mode](https://github.com/disjukr/activate-power-mode)

JQuery Snowfall（雪花飘落）
[https://github.com/loktar00/JQuery-Snowfall](https://github.com/loktar00/JQuery-Snowfall)

CSS3动画灯笼
[https://zmingcx.com/hanging-lantern.html](https://zmingcx.com/hanging-lantern.html)

lunar.js（日期工具） v1.6.7
 [https://gitee.com/6tail/lunar-javascript](https://gitee.com/6tail/lunar-javascript)

    ...
    <ul class="user-sidebar-count box b2-radius">
        <li>
            ...
            <div>
                <div class="user-item-name">
                    <?php echo __('<svg class="icon" aria-hidden="true"><use xlink:href="#icon-caidan"></use> </svg><span style="font-size:12px;"> </span>发布的文章', 'b2'); ?>
                </div>
        ...
        <?php if ((int) $newsflashes_open !== 0) { ?>
            <li>
                ...
                <div>
                    <div class="user-item-name">
                        <?php echo sprintf(__('<svg class="icon" aria-hidden="true"><use xlink:href="#icon-biaoshu"></use> </svg><span style="font-size:12px;"> </span>发布的%s', 'b2'), $newsflashes_name); ?>
                    </div>
                    <p class="user-item-count">
        ...
        <li>
            ...
            <div>
                <div class="user-item-name">
                    <?php echo __('<svg class="icon" aria-hidden="true"><use xlink:href="#icon-ceping"></use> </svg><span style="font-size:12px;"> </span>提交的评论', 'b2'); ?>
                </div>
                <p class="user-item-count">
        ...
        <li>
            ...
            <div>
                <div class="user-item-name">
                    <?php echo __('<svg class="icon" aria-hidden="true"><use xlink:href="#icon-daka"></use> </svg><span style="font-size:12px;"> </span>关注', 'b2'); ?>
                </div>
                <p class="user-item-count">
                    <?php echo $follow; ?>
                </p>
        ...
        <li>
            ...
            <div>
                <div class="user-item-name">
                    <?php echo __('<svg class="icon" aria-hidden="true"><use xlink:href="#icon-chanpin"></use> </svg><span style="font-size:12px;"> </span>粉丝', 'b2'); ?>
                </div>
                <p class="user-item-count">
                    <?php echo $fans; ?>
                </p>
        ...
        <li>
            ...
            <div>
                <div class="user-item-name">
                    <?php echo __('<svg class="icon" aria-hidden="true"><use xlink:href="#icon-cunchu"></use> </svg><span style="font-size:12px;"> </span>收藏的文章', 'b2'); ?>
                </div>
                <p class="user-item-count">
        ...
        <?php if ((int) $newsflashes_open !== 0) { ?>
            <li>
                ...
                <div>
                    <div class="user-item-name">
                        <?php echo sprintf(__('<svg class="icon" aria-hidden="true"><use xlink:href="#icon-chakanbingli"></use> </svg><span style="font-size:12px;"> </span>收藏的%s', 'b2'), $newsflashes_name); ?>
                    </div>
                    <p class="user-item-count">
        ...
        <?php if ((int) $open_shop !== 0) { ?>
            <li>
                ...
                <div>
                    <div class="user-item-name">
                        <?php echo __('<svg class="icon" aria-hidden="true"><use xlink:href="#icon-chaoshi"></use> </svg><span style="font-size:12px;"> </span>收藏的商品', 'b2'); ?>
                    </div>
                    <p class="user-item-count">
    ...
    <div class="user-info box b2-radius mg-b">
        ...
        <p class="b2-pd">
            ...
            <span v-show="userData.self || userData.admin" v-cloak>
                <?php echo sprintf(__('ID：%s号', 'b2'), '<b v-text="userData.id"></b>'); ?><img src="/wp-content/themes/b2Jitheme/Center/Assets/images/liang.png" alt="靓" style="width: 47px; height: 20px; margin-left: 5px; margin-top: 1px; -webkit-user-drag: none;">
            </span>
            <?php echo sprintf(__('已入驻本站%s天', 'b2'), '<b>' . b2_time_days($user_data->user_registered) . '</b>'); ?>
        </p>
        <p class="b2-pd">
            <span class="user-info-title">
                <?php echo __('性别：', 'b2'); ?>

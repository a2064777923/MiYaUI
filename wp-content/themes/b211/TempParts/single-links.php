    ...
    <div class="link-breadcrumb b2-hover mg-b"><?php echo LinkAction::link_breadcrumb($id); ?></div>
        <header class="entry-header">
            ...
            <div class="link-single-header">
                ...
                <div class="b2flex" style="gap:10px;">
                    <button class="jubao-button text favorite-button b2flex" style="color:#999"  onClick="jubao.close('links',<?php echo $id; ?>)"><?php echo b2_get_icon('b2-shield-user-line'); ?><?php echo __('举报','b2'); ?></button>

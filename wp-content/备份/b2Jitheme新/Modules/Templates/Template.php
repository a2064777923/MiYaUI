...
class Template{
    ...
    public function top_settings(){
        ...
        $top_options=apply_filters( 'b2_settings_modules_top_opts', array(
            'options'          => array(
        ...
        $top->add_field(array(
            ...
            'images_path'  => $top_options['images_path'],
            'images'       => $top_options['images'],
    ...
    public function index_settings(){
        ...
        $index->add_group_field( $index_group, array(
            ...
            'desc'=> __('标题前面会有一个漂亮的图标文件，不显示则留空','b2')
            // 'repeatable' => true, // Repeatable fields are supported w/in repeatable groups (for most types)
        ) );
        $index->add_group_field( $index_group, array(
            'name' => __('图标颜色','b2'),

...
$one_index_tj_user_toub_img =b2_get_option('Jitheme_index_tab5','one_index_tj_user_img');
$one_index_tj_user_toub_user =b2_get_option('Jitheme_index_tab5','one_index_tj_user_toub_user');
$default_image =B2_CHILD_URI.'/Center/Assets/images/tj.svg';
?>
<style>

</style>
<div id="Onecad-tuijian" class="module-posts ">
    <div id="user-list"  class="home-authors authors_jitheme" ref="searchUser">
        <div class="shop-box-title jitheme-post-title ">
            <div class="modules-title-box">
                <?php echo jithem_home_title($tj_user_title,$tj_user_desc,$one_index_tj_user_toub_img,$default_image,'/ask') ?>
            </div>
        </div>
                        ...
                        <div class="item-wrap box b2-radius">
                            ...
                            <div class="item-top b2-radius">
                                ...
                                <div class="author-info">
                                    <p><i class="b2font b2-file-list-2-line"></i>'.($user_data['user_title'] ? $user_data['user_title'] : (isset($user_data['desc']) ? $user_data['desc'] : $tips)).'</p>
                    ...
                    <div class="item-wrap box b2-radius">
                        ...
                        <div class="tobe-author-wrap">
                            <div class="tobe-author b2-radius">
                                <h2 class="item-title"><i class="Jifont Jifont-uu-3"></i><?php echo $one_index_tj_user_toub_title ?></h2> 

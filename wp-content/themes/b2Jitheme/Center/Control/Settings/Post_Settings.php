...
class Post
{
   ...
   public function init()
    ...
    public function Jitheme_post_page(){
        ...
        $Jitheme_Single->add_field(array(
            'name'    => __( '开启文章独立权限隐私声明', 'b2' ),
            'desc'    => __( '文章下载页面会有一个独立属于本文章的声明和隐私说明。', 'b2' ),
            'id'      =>  'Single_down_qxys',
            'type'             => 'select',
            'options'          => array(
                1 => __( '开启', 'b2' ),
        ...
        $Jitheme_Single->add_field(array(
            ...
            'id'   => 'index_Single_qx',
            'type' => 'text',
            'desc'    => __( '每一个文章都为同一个权限说明,如果您要设置每篇文章不同的权限请在文章对应的位置填写权限说明', 'b2' ),
            'default'          => self::$default_settings['links'],
        ) );
        $Jitheme_Single->add_field(array(
            'name' => __('隐私网址','b2'),
            'id'   => 'index_Single_ys',
            'type' => 'text',
            'desc'    => __( '每一个文章都为同一个隐私网址,如果您要设置每篇文章不同的隐私请在文章对应的位置填写隐私说明', 'b2' ),
            'default'          => self::$default_settings['links'],
        ) );
        $Jitheme_Single->add_field(array(

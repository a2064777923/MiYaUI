		...
		<main id="main" class="site-main mini-site-main">
            <div id="primary-home" class="content-area">
                ...
                <?php }else{ 
                    ...
                    '.($title ? '<div class="mini-submenu b2-radius "><i class="icon-home ico"></i>'.$title.'</div>' : '').'
                    <div class="b2-tab-link-in"></div><div class="mini-submenu b2-radius "><a href="'.b2_get_custom_page_url('link-register').'" class="" target="_blank"><i class="ico icon-collect-1"></i>申请入驻</a></div>

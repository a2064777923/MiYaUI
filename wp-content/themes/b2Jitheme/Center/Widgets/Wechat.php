    ...
    <div class="widget-content">
        ...
        <div class="add-admin">
            <div class="add-wrap">
                ...
                <h3 class="add-title"><i class="b2font b2-weixin"></i>添加客服 '.$instance['ads_ewmname'].'</h3>
                <h5><i class="b2font b2-checkbox-circle-line"></i>最短7天交付项目</h5>
                <h5><i class="b2font b2-checkbox-circle-line"></i>资深专业设计师</h5>
            </div>
        </div>
    </div>
</div>';

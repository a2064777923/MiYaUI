    ...
    var writeEditor = new Vue({
        ...
        mounted(){
          tinymce.init({
            ...
            toolbar1:' heading blockquote codesample numlist bullist | link b2imagelibrary b2video hr insertShotCode | removeformat',
            image_caption: true,
            ...
            setup: (editor)=>{
                ...
                //     // 确保不在 passive 事件中调用 preventDefault
    ...
    var writeFooter = new Vue({
        ...
        watch:{
            'download.rightsInput.role':{
                handler:function(newVal,oldVal){
                    if(this.download[this.downloadPicked]){
        ...
        mounted(){
            ...
            if(b2_write_data.post_id != 0){
                ...
                if(b2_write_data.download_edit){

...
$text = b2_get_option('newsflashes_main','newsflashes_can_post_text');
?>
                ...
                <div class="box b2-radius newsflashes-list">
                    <div class="newsflahses-cover" style="background-image:url(<?php echo b2_get_thumb(array('thumb'=>get_term_meta($term_id,'b2_tax_img' , true),'width'=>800,'height'=>200)); ?>)">
                        <div class="n-desc">
                            ...
                            <div class="po-n" v-show="b2_global.newsflashes_can_post == 1 || userData.is_admin" v-cloak>
                                <button @click="showForm"><?php echo $text; ?></button>
                            </div>
                        </div>
                    </div>
                                            ...
                                            $html .= '<li id="news-item-'.$_v['id'].'">
                                                ...
                                                <div class="news-item-content">
                                                    <div class="news-item-h">
                                                        ...
                                                        '.($_v['img'] ? b2_get_img(array('src'=>$_v['img'],'alt'=>$_v['title'],'class'=>array('news-item-img','b2-radius','loaded'))) : '').'
                                                    </div>
                                                    <div class="new-meta">
                                                        ...
                                                        <div class="new-meta-right">'.__('分享到','b2').'<span class="new-weibo" @click="openWin(\''.$_v['share']['weibo'].'\',\'weibo\',\''.$k.'\',\''.$_k.'\')">'.b2_get_icon('b2-weibo-line').'</span><span class="new-qq" @click="openWin(\''.$_v['share']['qq'].'\',\'qq\',\''.$k.'\',\''.$_k.'\')">'.b2_get_icon('b2-qq-line').'</span></div>
                                                    </div>
                                                </div>
                                            </li>';
                                        }
                                    ...
                                    <li v-for="(_item,_index) in item" :id="'news-item-'+_item.id">
                                        <div class="news-item-content">
                                            ...
                                            <div class="new-meta">
                                                ...
                                                <div class="new-meta-right"><?php echo __('分享到','b2'); ?><span class="new-weibo " @click="openWin(_item['share']['weibo'],'weibo',index,_index)" data-title="<?php echo __('分享到微博','b2'); ?>"><?php echo b2_get_icon('b2-weibo-line'); ?></span><span class="new-qq" data-title="<?php echo __('分享到QQ','b2'); ?>" @click="openWin(_item['share']['qq'],'qq',index,_index)"><?php echo b2_get_icon('b2-qq-line'); ?></span></div>
                                            </div>
                                        </div>
                                    </li>
                                </ul>
                    ...
                    <div class="b2-pagenav <?php echo $data['pages'] <= 1 ? 'b2-hidden-always' : ''; ?>" data-max="<?php echo $data['pages']; ?>">
                        <page-nav ref="goldNav" paged="<?php echo $paged; ?>" navtype="json" pages="<?php echo $data['pages']; ?>" type="p" :box="selecter" :opt="opt" :api="api" url="<?php echo  get_category_link($term_id); ?>" title="<?php echo $name; ?>" @return="get"></page-nav>
                    </div>
                </div>
            </div>
        </main>

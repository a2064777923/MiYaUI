            ...
            <?php if ( $comments ) : ?>
                ...
                <table>
                    <?php foreach ( $comments as $comment ) :   
                        ...
                        //$spam = '<a href="' . $spam_url . '">' . esc_html__( 'Spam', 'wp-admin-theme-cd' ) . '</a>';
                        //$trash = '<a href="' . $trash_url . '">' . esc_html__( 'Trash', 'wp-admin-theme-cd' ) . '</a>';
                        $edit = '<a href="' . $edit_url . '">' . esc_html__( 'Edit', 'wp-admin-theme-cd' ) . '</a>'; ?>
                        ...
                        <tr class="<?php echo $commen_status; ?>">
                            ...
                            <td>
                                <a class="comment-title" href="<?php echo get_permalink( $comment->comment_post_ID ) ?>#comment-<?php echo esc_html( $comment->comment_ID ); ?>">
                                    ...
                                    <?php echo esc_html__( 'on', 'wp-admin-theme-cd' ); ?>
...
if( ! function_exists('wp_admin_recent_comments_widget') ) :
	...
	function wp_admin_recent_comments_widget() {
		...
		wp_add_dashboard_widget('wp_recent_comments_db_widget', esc_html__( 'Recent Comments', 'wp-admin-theme-cd' ), 'wp_admin_recent_comments_widget_content');

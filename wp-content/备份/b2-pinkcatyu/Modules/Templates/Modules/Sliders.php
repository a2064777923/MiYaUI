...
class Sliders{
    ...
    public static function slider_1($data,$i){
        ...
        foreach ($post_data as $k => $v) {
            ...
            $html .= '<div class="slider-1-carousel slider-height" style="'.($data['slider_width'] === '0' ? 'width:100%' : 'width:'.$data['width'].'px').';max-width:100%;">
                    <div class="slider-in slider-info" style="height:0;padding-top:'.round($data['slider_height']/$data['width']*100,6).'%;max-width:100%">
                        '.b2_get_img(array('src'=>$thumb,'class'=>array('slider-img'))).'
        ...
        return '<div class="slider-1 carousel slider-height box  '.($data['slider_width'] === '0' ? 'slider-type-width' : '').' '.($data['slider_show_title'] ? 'slider-show-title' : 'show-title-none').'" '.$slider_setting.' style="'.((int)$data['slider_width'] == 1 || $data['show_widget'] ? 'width:'.$data['width'].'px' : 'width:100%').';max-width:100% ;margin:0 auto;">
            '.$html.'
        </div>';
    }
    ...
    public static function slider_3($data,$i){
        ...
        return '<div class="slider-3 slider-3-'.$i.'  '.($data['slider_show_title'] ? 'slider-show-title' : 'show-title-none').'"  style="width:'.$data['width'].'px">'.$html_slider.$html_last.'</div>';
    }
    ...
    public static function slider_6($data,$i){
        ...
        return  $css.'<div class="slider-6 slider-6-'.$i.'  '.($data['slider_show_title'] ? 'slider-show-title' : 'show-title-none').'"  style="width:'.$data['width'].'px">'.$html_first.$html_slider.$html_last.'</div>';
    }

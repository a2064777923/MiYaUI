...
class PluginsSupport{
    ...
    public function loader(){
        //是否使用了OSS_UPLOAD插件
        if(defined('OSS_ACCESS_ID') || class_exists('WPOSS') || defined('OSS_VERSION')){

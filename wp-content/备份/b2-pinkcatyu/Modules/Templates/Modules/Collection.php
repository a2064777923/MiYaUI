...
class Collection{
    ...
    public static function collection_4($data,$i,$return = false){
        ...
        $html = '<div class="jitheme-zt home-authors">
                        <div class="post-modules-top "><div class="modules-title-box"><div class="Onecad_title"><div>'.$data['title'].'</div> <div>'.$data['desc'].'</div></div></div> <div class="post-list-cats post-list-cats-has-title"><div class="post-carts-list-row"><a href="../collection" class="cat-list post-load-button picked"><span data-type="cat">
                                全部
                            </span></a></div></div></div>

    ...
    */
    ...
    public function post_settings(){
        ...
        $post_meta->add_field(array(
            ...
            'images_path'  => $post_meta_svg['image_path'],
        ...
        $post_meta->add_group_field( $video_group, array(
            ...
            'desc'=>__('请上传视频，或者直接输入视频地址，或直接粘贴视频网站的页面网址到此处。此为必填，否则前台无法播放视频。（支持类似 .mp4这种文件，支持B站视频、腾讯视频、西瓜视频、Youtube）','b2'),
        ) );

		...
		$html = '
			<div class="mission-widget" ref="missionWidget" data-count="'.$instance['mission_count'].'">
				...
				<div v-cloak v-if="data !== \'\'">
					...
					<img src="/wp-content/themes/b2-pinkcatyu/images/qddka.png" class="mb-2 h-auto w-full cursor-pointer" alt=""><div style="height:1em;"></div>
						<div class="" v-if="locked">'.b2_get_icon('b2-gift-2-line').__('幸运之星正在降临...','b2').'</div>
						<div class="" v-else-if="data.mission.credit == \'\'">'.b2_get_icon('b2-gift-2-line').__('点击签到今天的打卡奖励！','b2').'</div>
								...
								<ul v-if="type === \'today\'">
									<li v-for="item in data.mission_today_list.data">
										...
										<div class="user-mission-info">
											...
											<span class="mr-[5px] whitespace-nowrap rounded-[2px] bg-[#BBE070]/30 px-1 py-[1px]"><span class="text-xs font-medium text-[#7FB313]">已签到</span></span>
											</div>
										</div>
									</li>
								</ul>

...
class Jitheme_user extends WP_Widget{

    //小工具slug
	protected $widget_slug = 'ji-widget-user';

    //短代码名
	protected static $shortcode = 'ji_widget_user';
...
function Jitheme_widget_user() {
	register_widget( 'Jitheme_user' );
}
add_action( 'widgets_init', 'Jitheme_widget_user' );
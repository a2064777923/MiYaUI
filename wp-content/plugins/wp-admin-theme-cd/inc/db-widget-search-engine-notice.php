    ...
    function wp_admin_search_engine_notice_widget_content() { ?>
        ...
        <div class="wpat-seo-vis">
            <div class="wpat-seo-vis-focus">
                ...
                <div><?php esc_html_e( 'Your website is currently not visible to search engines!', 'wp-admin-theme-cd' ); ?></div>
            </div>
        </div>
...
if( ! function_exists('wp_admin_search_engine_notice_widget') ) :
	...
	function wp_admin_search_engine_notice_widget() {
		...
		wp_add_dashboard_widget('wp_search_engine_notice_db_widget', esc_html__( 'Search Engine Visibility', 'wp-admin-theme-cd' ), 'wp_admin_search_engine_notice_widget_content');

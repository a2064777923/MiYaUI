...
/*****************************************************************/
/* WP RECENT POSTS DASHBOARD WIDGET */
/*****************************************************************/

// WP RECENT POSTS WIDGET --> CALLABLE WIDGET CONTENT

if( ! function_exists('wp_admin_recent_posts_widget_content') ) :

    function wp_admin_recent_posts_widget_content() { 
...
// WP RECENT POSTS WIDGET --> ADD DASHBOARD WIDGET

if( ! function_exists('wp_admin_recent_posts_widget') ) :

	function wp_admin_recent_posts_widget() {

		wp_add_dashboard_widget('wp_recent_posts_db_widget', esc_html__( 'Recent Posts', 'wp-admin-theme-cd' ), 'wp_admin_recent_posts_widget_content');

	}

endif;

add_action('wp_dashboard_setup', 'wp_admin_recent_posts_widget');
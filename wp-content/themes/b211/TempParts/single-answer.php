    ...
    <header class="entry-header">
        ...
        <div id="post-meta">
            ...
            <div class="post-meta-row">
                ...
                <div class="b2flex" style="gap:10px;font-size:14px;">
                    <div class="jubao-button" @click="jubao.close('answer',<?php echo $post->ID; ?>)"><?php echo b2_get_icon('b2-shield-user-line'); ?><?php echo __('举报','b2'); ?></div>
                    <a href="<?php echo $parent_link.'?answer_id='.$post_id; ?>" target="_blank" v-if="postData.can_edit" class="single-button-download red"><?php echo __('编辑','b2'); ?></a>
                </div>
            </div>
        </div>
    </header>

...
?>
    ...
    <style>
            ...
            @media screen and (min-width:720px){
                ...
                ul.b2_gap > li{width:'.$r.'%!important}
...
$thumb = b2_get_thumb(array('thumb'=>$thumb));
...
?>
<div class="ji_jb_bg" style="background-image:url(<?php echo $thumb; ?>);"></div>
 ...
 <!--   </div>-->
<div class="wrapper">
    <div class="collection-list-top-info wrapper ji-bg-white  b2-radius">
        <div class="coll-img  b2-radius">
            <img src="<?php echo $thumb; ?>">
            <i class="col_thumb " style="background-image:url(<?php echo $thumb; ?>)"></i>
        ...
        <div class="coll-info">
            <h1><?php echo $title; ?></h1>
            <p class="coll-num">一共<b class="b2-color"><?php echo $data['count'] ?></b>篇文章</p>
            <div class="coll-text"><p><?php echo jitheme_desc_unll($desc); ?></p>
        </div>
            <div class="read-more mg-t">
                <a href="<?php echo b2_get_custom_page_url('collection'); ?>" target="_blank"><?php echo sprintf(__('往期%s','b2'),$collection_name).b2_get_icon('b2-arrow-right-s-line'); ?></a>
            </div>
    ...
    <div class="b2-pagenav box post-nav b2-radius <?php echo $data['pages'] <= 1 ? 'b2-hidden-always' : ''; ?>" data-max="<?php echo $data['pages']; ?>">

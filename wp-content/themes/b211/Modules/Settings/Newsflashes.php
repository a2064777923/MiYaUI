...
class Newsflashes{
    ...
    public static $default_settings = array(
       ...
       'newsflashes_can_post_open'=>1,
       'newsflashes_can_post_text'=>'我要爆料'
    );
    ...
    public function newsflashes_settings(){
        ...
        $newsflashes->add_field(array(
            'name'    => __( '是否允许用户发布', 'b2' ),
            'id'=>'newsflashes_can_post_open',
            'type'=>'select',
            'options'=>array(
                1=>__('开启','b2'),
                0=>__('关闭','b2')
            ),
            'default'=>self::$default_settings['newsflashes_can_post_open'],
            'desc'=>__('如果关闭，则只有管理员和编辑可以发布','b2')
        ));

        //按钮文本
        $newsflashes->add_field(array(
            'name'    => __( '发布按钮文字', 'b2' ),
            'id'=>'newsflashes_can_post_text',
            'type'=>'text',
            'default'=>self::$default_settings['newsflashes_can_post_text'],
            'desc'=>__('发布按钮文字，如果为空，则使用默认文字','b2')
        ));

...
class Comment{
                ...
                <div class="comment-meta" role="complementary">
                    <div class="comment-user-info">
                        <div class="">
                            ...
                            <?php if ( lmy_get_option('page_ipgsd')){ ?>
                            <span>（来自<?php echo convertip(get_comment_author_ip());?>）</span>
                            <?php } ?>
    ...
    public static function submit_comment($args){
        ...
        $args['author'] = b2_remove_kh($args['author'],true);

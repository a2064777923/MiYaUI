...
<div class="b2-single-content wrapper ">
    ...
    <div id="primary-home" class="content-area">
        <?php do_action('b2_single_ask_content_before'); ?>
            ...
            <div class="ask-answer-box ji-ask-answer-box box b2-radius">
                ...
                <div class="jitheme-ask-list answer-list" v-if="data !== ''">
                    ...
                    <template v-else>
                        ...
                        <div :class="['answer-item',{'new-comment':item.new}]" v-for="(item,i) in data.data" :key="i" :id="'answer-item-'+item.post_id">
                            <div class="answer-top b2flex">
                                <div class="b2flex answer-top-left">
                                    ...
                                    <div class="author-info">
                                        ...
                                        <div class="b2flex">
                                            <div v-html="item.author.lv.lv.lv ? item.author.lv.lv.icon : ''"></div>
                                            <div v-html="item.author.lv.vip.lv ? item.author.lv.vip.icon : ''"></div>
                                        </div>
                                    </div>
                                </div>
                                <div class="answer-top-right">
                            ...
                            <div class="b2flex answer-meta" v-if="isInv(item.author.id) || item.best">
                                ...
                                <div class="green answer-best" v-if="item.best"><?php echo b2_get_icon('b2-checkbox-circle-line').__('最佳答案','b2'); ?></div>
                            </div>

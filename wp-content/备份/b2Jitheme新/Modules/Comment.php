...
class Comment
{
    ...
    public static function comment_callback($comment, $args, $depth)
    {
        ...
        <li>
            <article
                class="<?php echo empty($args['has_children']) ? 'comment' : 'parent comment';
    ...
    public static function get_comment_author_data($user_id, $author = '', $type = false)
    {
        ...
        if ($user_id) {
            ...
            $data = array(
                ...
                'lv' => $lv,
                'vip' => $vip,
                'ji_lv_icon' => User::get_lv_icon($lv),  // 添加ji_lv_icon到$data
                'ji_vip_icon' => User::get_lv_icon($vip)  // 添加ji_vip_icon到$data
                
            );
            
            $data = apply_filters('ji_comment_author_data', $data, $user_id, $type);

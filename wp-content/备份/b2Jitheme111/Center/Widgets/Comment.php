...
class Comment extends \WP_Widget{
	...
	public static function get_widget( $atts ) {
		...
		if ( empty( $widget )) {
			...
			$widget .= '</div><div class="comment-widget-nav"><span :class="{\'locked\':prev || locked}" @click="prevAc()">'.b2_get_icon('b2-arrow-left-s-line').'</span><span :class="{\'locked\':next || locked}" @click="nexAc()">'.b2_get_icon('b2-arrow-right-s-line').'</span></div>';

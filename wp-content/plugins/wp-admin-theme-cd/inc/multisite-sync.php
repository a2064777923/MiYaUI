...
if ( is_multisite() ) {
	...
	if ( ! function_exists( 'wp_admin_theme_cd_update_blog' ) ) :
		...
		function wp_admin_theme_cd_update_blog( $blog_id = null ) {
            ...
            // get option fields
            $init_wp_options = new WP_Admin_Theme_CD_Options;
		...
		function wp_admin_theme_cd_update_page() {
			...
			<div class="wrap">
				...
				<table class="wp-list-table widefat fixed striped posts">
					...
					<tbody>
					    <?php $is_visible = '<span class="sys-status enable"><span class="dashicons dashicons-yes"></span> ' . esc_html__( 'Visible', 'wp-admin-theme-cd' ) . '</span>';
                        ...
                        // get all options
                        $options = get_option('wp_admin_theme_settings_options'); // Get specific options data
                        ...
                        foreach( $options as $key => $value ) {                            
                            ...
                            if( $key == 'company_box_logo' ) {
                                ...
                                echo '<tr><td>' . $label[ $key ] . ':</td><td>' . $status . ' ' . esc_html__( 'Pixel', 'wp-admin-theme-cd' ) . '</td></tr>';
                                ...
                                if( empty( $value ) ) $status = esc_html__( 'Welcome Back.', 'wp-admin-theme-cd' );
                                ...
                                if( empty( $value ) ) $status = esc_html__( 'Not added', 'wp-admin-theme-cd' );

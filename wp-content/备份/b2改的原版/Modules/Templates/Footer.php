                ...
                <div class="bar-middle" v-cloak>
                    ...
                    ?>
                        ...
                        <?php if($aside_user && !$audit) { ?>
                            <div class="minewtop-list" @click="show('user')">
                               <i class="b2font b2-user-heart-line "></i>
                                <span><?php echo __('个人中心','b2'); ?></span>
                            </div>
                        <?php } ?>
                        <?php if($shop_open && !$audit) { ?>
                            <div class="minewtop-list" @click="show('cart')">
                                <?php echo b2_get_icon('b2-shopping-cart-2-line'); ?>
                                <b v-show="carts.count" class="bar-mark"></b>
                                <span  ><?php echo __('购物车','b2'); ?></span>
                            </div>
                        <?php } ?>
                        <?php if($shop_open && !$audit) { ?>
                            <div class="minewtop-list" @click="show('coupon')">
                                <?php echo b2_get_icon('b2-coupon-2-line'); ?>
                                <span  ><?php echo __('优惠劵','b2'); ?></span>
                            </div>
                        <?php } ?>
                        <?php if($aside_mission && !$audit) { ?>
                            <div class="minewtop-list" @click="show('mission')">
                                <?php echo b2_get_icon('b2-gift-2-line'); ?>
                                <span ><?php echo __('今日签到','b2'); ?></span>
                            </div>
                        <?php } ?>
                        <?php if($aside_dmsg && !$audit) { ?>
                            <div class="minewtop-list" @click="show('dmsg','<?php echo $dmsg_url;?>')">
                                <b v-show="dmsg.count" class="bar-mark"></b>
                                <?php echo b2_get_icon('b2-mail-send-line'); ?>
                                <span   v-if="dmsg.count"><?php echo __('有新私信','b2'); ?></span>
                                <span   v-else><?php echo __('私信列表','b2'); ?></span>
                            </div>
                        <?php } ?>
                        ...
                        <?php if (1 === B2_ASIDE_SEARCH) { ?>
                            <div class="minewtop-list" @click="showSearch()">
                                <?php echo b2_get_icon('b2-search-line'); ?>
                                <span  ><?php echo __('快速搜索','b2'); ?></span>
                            </div>
                        <?php } ?>
                    ...
                    <div class="minewtop">
                        <?php if($chat_open !== 'none'){ ?>
                            <div class="minewtop-list" @click="chat">
                                <?php echo b2_get_icon('b2-customer-service-2-line1'); ?>
                                <span ><?php echo __('在线客服','b2'); ?></span>
                            </div>
                        <?php } ?>
                        ...
                        <div class="minewtop" @click="goTop">
                           <div id="return-top" class="minewtop-list">
           <?php echo b2_get_icon('b2-rocket-2-line'); ?>
                            <span ><?php echo __('返回顶部','b2'); ?></span></div>

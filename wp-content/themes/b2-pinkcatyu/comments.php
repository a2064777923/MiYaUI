			...
			<div class="com-form" ref="formData" data-commenter='<?php echo $get_commenter; ?>'>
				...
				<div class="b2-radius">
					...
					<div class="com-form-textarea" :id="drawing ? 'drawing-box' : ''" ref="_textarea_box">
						<textarea v-show="!drawing" id="textarea" class="textarea" ref="textarea_box" placeholder="<?php echo __('说说你的看法','b2'); ?>" @focus="focus = true;((data.name && data.user_email) || b2token  ? show.info = false : show.info = true)" @blur="focus = false;((data.name && data.user_email) || b2token ? show.info = false : show.info = true)"></textarea>
				...
				<div class="com-form-button">
					...
					<div class="com-form-button-r">
						...
						<button @click="submit()" :disabled="subLocked || locked" :class="[{'b2-loading':subLocked}]" class="comments-mrxu-close"><?php echo __('提交','b2'); ?></button>
					</div>
				</div>
			</div>
		</div>

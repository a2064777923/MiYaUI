...
<div id="Jitheme_about_main" class="Jitheme_about_main">
            ...
            <div class="about-contact  b2-radius">
                <div class="contact-in">
                    ...
                    <div class="c-menus flex f-items f-2 b2-radius">
                        <div class="c-menu b2-radius"><div class="txt"><i class="jitheme jitheme-wechat-fill"></i> 联系方式一</div></div>
                        <div class="c-menu b2-radius"><div class="txt"><i class="jitheme jitheme-qq-fill"></i> 联系方式二</div></div>
                    </div>
                    <div class="c-toggles">
    ...
    <div class="about-serve main3 wrapper">
                ...
                <div class="intro-wrap c-item f-item">
                    <div class="c-box f-box b2-radius">
                        <div class="intro">
                            ...
                            <div class="item-list">
                                <ul>
                                    <li><i class="ico icon-option"></i> 合作洽谈</li>
                                    <li><i class="ico icon-option"></i> 广告投放</li>
                                    <li><i class="ico icon-option"></i> 反馈建议</li>
                                    <li><i class="ico icon-option"></i> 投稿求职</li>
                                </ul>
                            </div>
                        </div>
                    </div>

    ...
    class CSF
    {
        ...
        public static function add_admin_enqueue_scripts()
        {
            ...
            wp_enqueue_script('wp-color-picker');
                ...
                wp_enqueue_style('csf-fa', B2_CHILD_URI.'/inc/csf-framework/assets/css/font-awesome.min.css', array(), '4.7.0', 'all');

                // wp_enqueue_style( 'csf-fa', 'https://cdn.jsdelivr.net/npm/font-awesome@4.7.0/css/font-awesome'. $min .'.css', array(), '4.7 

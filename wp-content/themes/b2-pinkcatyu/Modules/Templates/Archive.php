...
class Archive{
    ...
    public static function filter_cat($cats,$term,$request,$url){
        ...
        foreach($cats as $k=>$v){
            ...
            $imgicon = get_term_meta($_term->term_id,'b2_tax_imgicon',true);
            if(isset($_term->term_id)){
                if($is_tax){
                 ...
                 $a .= '<a href="'.$url.'" class="'.($term->term_id == $v || isset($_GET['post_cat']) && $_GET['post_cat'] == $v ? 'current' : '').'" title="'.$_term->name.'"><img src="'.$imgicon.'"> '.$_term->name.' </a>';
            }
        }
    ...
    public function archive_top_info(){
        ...
        $img = b2_get_thumb(array('thumb'=>$img));
        ...
        ?>
       <div class="tax-header categorypage-new">
            <div class="cate-header-img" style="background-image:url(/wp-content/themes/b2-pinkcatyu/images/2023122102144992.jpg)">
                <div class="wrapper">
                    <h2 class="webfont"><?php echo $title; ?></h2>
        ...
        <div class="wrapper">
                    ...
                    <div class="tax-info-item ji-ac-tags">
                        <a href="/vips" class="fliter-button vip b2-radius">升级会员</a>
                    </div>
                        <div class="tax-info-item">

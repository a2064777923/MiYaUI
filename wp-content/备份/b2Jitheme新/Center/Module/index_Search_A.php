...
$index_search_cd ='';
if($search_off == 1){ 
    $index_search_cd = index_search_cd();
                        ...
                        <div class="cont">
                            <div class="left-cont" id="jitheme_search">
                                ...
                                method="get" target="_blank">
                                    ...
                                    <div class="jitheme_fbu" ><a href="/mission/today">每日签到</a></div>
                                </form>
                                ...
                                target="_blank">
                                    ...
                                    <button type="submit" name="" class="btn" ><i class="b2font b2-search-line "></i>
                                        站内搜索
                                    </button>
                                    <div class="jitheme_fbu" ><a href="/mission/today"><i class="jktheme JK-qiandao"></i> 每日签到</a></div>
                                </form>

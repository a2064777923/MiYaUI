            ...
            <div class="content-footer post-content-footer" v-cloak>
                <div class="post-content-footer-in">
                    ...
                    <div class="content-footer-zan-cai b2tooltipbox" data-title="'.__('喜欢','b2').'">
                        ...
                        <span @click="vote(\'up\')" :class="postData.up_isset ? \'picked\' : \'\'">'.'<button onclick="playAudio()" class="tip-button"><span class="tip-button__text"><div>已有</div><div><b v-text="postData.up"></b> 人</div><div>点赞</div></span> <div class="emoji-wrapper"><div class="emoji" style="--emoji-y-multiplier: 0; --emoji-x-multiplier: 0; --emoji-scale-multiplier: 0; --emoji-rotation-multiplier: 0; opacity: 1; --shine-opacity-multiplier: 0.4; --shine-bg-multiplier: 50%;">🥳</div></div></button></span>
